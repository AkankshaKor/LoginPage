...
public class FacebookLoginActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, View.OnClickListener {
...
private  static String TAG="MAIN_ACTIVITY";
    ...
    public void goMainScreen(){
        Intent intent = new Intent(this, MainnnnActivity.class);
